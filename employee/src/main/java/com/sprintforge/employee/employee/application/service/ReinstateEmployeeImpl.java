...
import com.sprintforge.employee.employee.application.port.in.command.ReinstateEmployee;
...
public class ReinstateEmployeeImpl implements ReinstateEmployee {
    ...
    public Employee handle(ReinstateEmployeeCommand command) {
        ...
        EmploymentHistory newPeriod = EmploymentHistory.create(
                employee,
                EmploymentHistoryType.REINSTATEMENT,
                command.date(),
