...
import com.sprintforge.employee.employee.application.port.in.command.SuspendEmployee;
...
public class SuspendEmployeeImpl implements SuspendEmployee {
    ...
    @Override
    public Employee handle(SuspendEmployeeCommand command) {
        ...
        employeeEventPublisher.publishEmployeeSuspended(
                EmployeeIntegrationMapper.fromSuspended(employee)
        );
        return employee;
    }
